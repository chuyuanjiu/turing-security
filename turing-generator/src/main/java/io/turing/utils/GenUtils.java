...
import io.turing.entity.ColumnEntity;
import io.turing.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		mainPath = StringUtils.isBlank(mainPath) ? "io.turing" : mainPath;
